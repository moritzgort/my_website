...
<!-- > Plot 1: 2 bedrooms are more expensive; Plot 2: Higher ratings means higher price -->
...
```{r}
# ggplot(listings, aes(x=minimum_nights)) + # Filtered out everything above 4 min. nights in listings_clean
#   geom_histogram()
# 
# ggplot(listings, aes(x=minimum_nights)) + # Filtered out everything above 4 min. nights in listings_clean
#   geom_histogram() +
...
<!-- > Extreme values description here -->
...
<!-- ggplot(listings_clean, aes(x = price_4_nights)) + -->
<!--   geom_density() -->

<!-- ggplot(listings_clean, aes(x = log(price_4_nights))) + -->
<!--   geom_density() -->
...
<!-- model4 <- lm(log(price_4_nights) ~ neighbourhood_simplified, data = listings_clean) -->
...
<!-- # Prediction using model5; model3 and model 5 have by far the highest R^2 and model5 is less prone to colinearity even though it uses more variables -->

<!-- listings_selection <- listings_clean %>%  -->
...
<!-- exp(predict(model5, newdata = listings_specifications, interval = "confidence")) -->

<!-- # 95% CI for price for our specifications between $529.84 and $599.06 for our trip -->
